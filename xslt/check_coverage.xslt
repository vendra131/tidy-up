...
<xsl:stylesheet version="2.0"
	...
	<xsl:template match="/">
        <xsl:variable name="excluded">
            ...
            <xsl:for-each 
		    select="$javadoc//class[
		    annotation/@name='Generated' or
		    annotation/@name='ExcludeFromCodeCoverage' or
		    ends-with(@qualified,'DTO') or
		    ends-with(@qualified,'Entity') or
		    ends-with(@qualified,'Constants')
		    ]/@qualified">
