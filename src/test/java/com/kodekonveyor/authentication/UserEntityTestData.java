...
public class UserEntityTestData {
  ...
  public static final long USER_ID_FOR_UNAUTHENTICATED_CALL = 4999;
  ...
  public static UserEntity getForUnauthicatedCalls() {
    final UserEntity userEntity = new UserEntity();
    userEntity.setAuth0id(AUTH0ID);
    userEntity.setLogin(LOGIN);
    userEntity.setId(USER_ID_FOR_UNAUTHENTICATED_CALL);
    return userEntity;
  }
